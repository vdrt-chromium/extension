         ...
         */ !(function (t, n) {
          ...
          !(function () {
            ...
            function Z(e, t, n, r) {
              ...
              if (!r && (ue(t), (t = t || u), f)) {
                ...
                if (!(C[e + " "] || (p && p.test(e)))) {
                  if (((d = e), (h = t), 1 === m && ($.test(e) || W.test(e)))) {
                    for (
          ...
          function Xe(e, t, n, r) {
            ...
            if (
              ...
              for (s = (a = k.map(De(o, "script"), _e)).length; f < p; f++)
                (l = o),
                  f !== d &&
                    ((l = k.clone(l, !0, !0)),
                    s && k.merge(a, De(l, "script"))),
                  n.call(e[f], l, f);
              if (s)
                for (
          ...
          function Ve(e, t, n) {
            for (
              ...
              n || 1 !== r.nodeType || k.cleanData(De(r)),
                r.parentNode &&
          ...
          k.extend({
            ...
            clone: function (e, t, n) {
              ...
              if (
                ...
                for (a = De(s), r = 0, o = (i = De(e)).length; r < o; r++)
                  ze(i[r], a[r]);
              if (t)
                if (n)
                  for (
                    i = i || De(e), a = a || De(s), r = 0, o = i.length;
                    r < o;
                    r++
                  )
                    Ue(i[r], a[r]);
          ...
          function Ft(e, t, n, r) {
            ...
            else for (o in t) Ft(e + "[" + o + "]", t[o], n, r);
          }
    ...
    (() => {
        ...
        p = function () {
          if (
            (c()("article video")
              ...
              .each((e, n) => {
                ...
                if (
                  ...
                  const e =
                    "https://www.instagram.com/graphql/query/?query_hash=55a3c4bad29e4e20c20ff4cdfd80f5b4&variables={%22shortcode%22:%22".concat(
                      o,
                      "%22}",
                    );
                  fetch(e)
                    ...
                    .then((e) => {
                      let {
                        data: {
                          shortcode_media: { video_url: n, owner: i },
                        },
                      } = e;
                      const a = "Video by ".concat(i.username);
                      u(a, n).then((e) => {
                        r.push(e), t({ list: r, header: a, id: o.toString() });
                      });
                    });
                }
              }),
            !window.location.pathname.match(/\/(tv|p|reel)\/([^/]+)/))
          ) {
            const e = [],
            ...
            (n.src = chrome.runtime.getURL(
              ...
              (n.onload = () => {
                const n = document.head.getAttribute("VideoUrlForStory");
                if (
                  (document.head.removeAttribute("VideoUrlForStory"),
                  n !== d && ((d = n), n))
                ) {
                  const r = "".concat(window.location.pathname.split("/")[2]);
                  u(r, n).then((r) => {
                    e.push(r),
                      t({ list: e, header: window.location.href, id: n }),
                      document.head.setAttribute("VideoUrlForStory", "");
                  });
                }
              }),
              n.remove();
      ...
      c()(window).on("load", function () {
        ...
        chrome.runtime.onMessage.addListener(
          async (e) => ("pageUpdated" === e.action && p(), !0),
        );
    })();
})();
//# sourceMappingURL=instagramContent.js.map
